...
optFlags = ""
#############################################################################
makeCommand1 = flagHeader + SRC_NAME + "-c -o " + OBJ_NAME + ktraceFlag
makeCommand2 = "nvcc -I. -O0 -use_fast_math -arch=sm_30 -lm  -DGPU_TIMER -o common.o -c common.c"

linkFiles = "lud.o common.o"
...
def collectData(dir_name, result_name, keep_after_ll):
    ...
    os.system("nvcc -arch=sm_30 " + dir_name + ".o " + linkFiles + " -o " + OUT_NAME + " -O0")
